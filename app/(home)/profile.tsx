...
export default function ProfileScreen() {
  ...
  useEffect(() => {
    ...
    const isAutoGenerated =
      !name ||
      name.startsWith('anon_') ||
      (authEmail && name === authEmail.split('@')[0]);
    if (isAutoGenerated) {
      setEditName('');
      setEditEmail(authEmail.startsWith('anon_') ? '' : authEmail);
      ...
      supabase
        ...
        .then(({ data }) => {
          if (data) {
            ...
            if (data.display_name && !data.display_name.startsWith('anon_')) setProfileDisplayName(data.display_name);
          }
        });
      supabase
        .from('recipes')
          ...
          <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
            <Pressable style={s.roleModalOverlay} onPress={() => setEditOpen(false)}>
              <Pressable style={s.roleModalSheet} onPress={() => {}}>
                ...
                <Text style={s.roleModalTitle}>{isNamePrompt ? 'What should we call you?' : 'Edit Profile'}</Text>
